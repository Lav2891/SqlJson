...
public class OTP extends AppCompatActivity {
    ...
    String URL = "http://pepbill.in/pepbill/firstproject/employee_forgetpassword2.php";
    ...
    public void upload(){
        try {
            params.put("emp_newpassword", otp);
            Log.e("PARAM", otp);
