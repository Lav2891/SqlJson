...
public class MainActivity extends AppCompatActivity
    ...
    String URL = "http://192.168.0.102/firstproject/employee_home.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        navigationView.setItemTextAppearance(R.style.navtextcustom);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_addemployee) {
            Intent intent = new Intent(MainActivity.this,Register.class);
            startActivity(intent);
            Log.e("ADD EMPLOYEE","add employee");
        } else if (id == R.id.nav_profile) {
            Intent intent = new Intent(MainActivity.this,Profile.class);
            startActivity(intent);

        }else if (id == R.id.nav_leavmanagement) {
